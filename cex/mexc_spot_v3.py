...
from config.config import api_key, secret_key, mexc_host
import time
from config import config


class MexcAccount:
    def __init__(self, api_key, secret_key, base_url="https://api.mexc.com"):
    ...
    def create_signature(self, params):
        ...
        # Используем self.api_secret вместо self.secret_key
    ...
    def print_balances(self):
        ...
        if data and 'balances' in data:
            ...
            print("No balances available or error occurred.")

# Использование класса
if __name__ == "__main__":
    # Создаем экземпляр класса
    mexc_account = MexcAccount(api_key, secret_key)

    # Вывод балансов
    mexc_account.print_balances()
